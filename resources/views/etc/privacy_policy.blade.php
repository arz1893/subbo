...
@section('content')
    <div class="container">
        ...
        <p class="flow-text" style="text-align: justify;">
            Sunwell System operates the sunwellsystem.com website, which provides the SERVICE. <br> <br>
            ...
            which is accessible at sunwellsystem.com , unless otherwise defined in this Privacy Policy. <br> <br>
        </p>
        ...
        <p class="flow-text" style="text-align: justify">
            ...
            to review the Privacy Policy of these websites, get more info. We have no control over, and
